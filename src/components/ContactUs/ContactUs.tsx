...
export interface ContactUsProps {
  commentTypes: CommentTypeItem[];
}

export const ContactUs = ({ commentTypes }: ContactUsProps) => (
  <>
    <div className="grid-row margin-top-5">
      <h3 className="text-bold font-heading-2xl">Contact Us</h3>
      <div className="flex-force-break" />
      <p>
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut fringilla massa in lectus volutpat scelerisque. Cras
        eu leo vel lacus tincidunt molestie. Vestibulum faucibus enim sit amet pretium laoreet.
      </p>
      <div className="flex-force-break" />
